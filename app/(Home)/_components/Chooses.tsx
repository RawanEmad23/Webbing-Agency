...
export default function Chooses() {
  ...
  return (
    <div className="place-self-center min-h-screen flex items-center justify-center mt-[70px]">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-y-0 lg:space-x-8"> 
        ...
        <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left"> 
          <h1 className="text-xxl font-bold font-oxanium mb-6">
            Why <span className="text-[#1F7099] text-xxl font-bold font-oxanium">Choose </span> Us?
          </h1>
          ...
          <div className="space-y-8">
            ...
            src={img2}
            width={400}
            height={400} alt="" className="w-8 mb-4 sm:mb-0" />
              </div>
              <div>
            ...
            src={img2}
            width={400}
            height={400} alt="ki" className="w-8 mb-4 sm:mb-0" />
              </div>
              <div>
            ...
            src={img3}
            width={400}
            height={400} alt="d" className="w-8 mb-4 sm:mb-0" />
              </div>
              <div>
