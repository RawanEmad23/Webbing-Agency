...
export default function Chooses() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center mt-16 px-4 lg:px-0">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-y-8 lg:gap-x-12"> 
        ...
        <div className="relative hidden lg:block">
          <Image
            ...
            alt="Team working"
          />
          <div className="absolute bottom-0 left-10 bg-white p-4 shadow-lg rounded-lg flex gap-x-6">
            <div>
